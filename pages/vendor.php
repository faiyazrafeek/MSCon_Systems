...
?>
	...
	<div class="modal-dialog">
	  <div class="modal-content" style="height:auto">
			  ...
			  <form class="form-horizontal" method="post" action="vendor_update.php" enctype='multipart/form-data'>
                
				<div class="form-group">
					<label class="control-label col-lg-3" for="name">Vendor Name</label>
					<div class="col-lg-9">
						<input type="hidden" class="form-control" id="id" name="id" value="<?php echo $row['cust_id'];?>" required>  
						<input type="text" class="form-control" id="name" name="first" value="<?php echo $row['cust_name'];?>" required>  
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-lg-3" for="name">Description</label>
					<div class="col-lg-9">
						<input type="text" class="form-control" id="desc" name="last" value="<?php echo $row['cust_desc'];?>" required>  
					</div>
				</div>				
				<div class="form-group">
  ...
  <div class="modal-dialog">
    <div class="modal-content" style="height:auto">
        ...
        <div class="form-group">
          ...
          <div class="col-lg-9">
            <textarea class="form-control" id="price" name="desc" placeholder="Vendor Description"></textarea>  
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-lg-9">
            <textarea class="form-control" id="price" name="address" placeholder="Vendor Description"></textarea>  
          </div>
        </div>
        ...
        <div class="form-group">
          <label class="control-label col-lg-3" for="price">Contact Number</label>
          <div class="col-lg-9">
            <textarea class="form-control" id="price" name="contact" placeholder="Contact Number"></textarea>  
          </div>
        </div>
              </div>
              <div class="modal-footer">
