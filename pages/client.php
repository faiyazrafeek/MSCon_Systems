...
<html>
  <head>
    ...
    <title>Client | <?php include('../dist/includes/title.php');?></title>
...
?>
	...
	<div class="modal-dialog">
	  <div class="modal-content" style="height:auto">
        ...
        <div class="form-group">
                    <label for="date">Client Address</label>
               ...
               <div class="form-group">
                    <label for="date">Client Contact #</label>
                    <div class="input-group col-md-12">
                ...
                <div class="box-body">
                  ...
                  <form method="post" action="client_add.php" enctype="multipart/form-data">
					  ...
					  <div class="form-group">
						...
						<div class="input-group col-md-12">
						  <input type="text" class="form-control pull-right" id="date" name="name" placeholder="Client Name" required>
						</div><!-- /.input group -->
					  </div><!-- /.form group -->
		         <div class="form-group">
                    <label for="date">Address</label>
                    <div class="input-group col-md-12">
                      <textarea class="form-control pull-right" id="date" name="address" placeholder="Client Complete Address" required></textarea>
                    </div><!-- /.input group -->
                  </div><!-- /.form group -->
               <div class="form-group">
                    <label for="date">Contact #</label>
                    <div class="input-group col-md-12">
                      <input type="text" class="form-control pull-right" id="date" name="contact" placeholder="Contact # of client" required>
                    </div><!-- /.input group -->
                  </div><!-- /.form group -->    
